...
function AuthPage() {
  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center py-40 text-center text-white max-w-6xl mx-auto">
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
          ...
          />
          <button className="bg-red-700  py-1 px-2 rounded flex flex-row text-2xl">
            Get Started
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
          <div className="flex-1 relative">
            ...
            <div className="flex items-center gap-2 absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
              <img src="/stranger-things-sm.png" alt="Stranger Things Small" className="h-full" />
              <div className="flex justify-between items-center w-full">
                <div className="flex flex-col gap-0">
                  <span className="text-md lg:text-lg font-bold">Stranger Things</span>
                  <span className="text-sm text-blue-500">Downloading...</span>
                </div>
                <img src="/download-icon.gif" className="h-12 align-middle" alt="Download Icon" />
              </div>
            </div>
          </div>
          <div className="flex-1 md:text-left text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-balance">
                Donwload your shows to watch offline
            </h2>
